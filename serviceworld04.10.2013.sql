...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 04, 2013 at 12:50 PM
...
INSERT INTO `category` (`id`, `name`, `parent`, `description`, `styleClass`, `order`, `createdDate`, `createdBy`, `state`) VALUES
(8, 'shoe', 0, 'shoe', 'shoe', 1, 1380787311, 'admin', 1),
(9, 'a', 8, 'a', 'a', 1, 1380788551, 'admin', 1),
(10, 'dsada', 9, 'dá', 'sss', 2, 1380788572, 'admin', 1),
(11, 'sda', 0, 'dá', '', 2, 1380788590, 'admin', 1),
(12, 'weqewqe', 8, 'ee', 'q', 1, 1380788599, 'admin', 1);
